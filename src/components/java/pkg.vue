          ...
          <el-table
                ...
                <el-form label-position="left" inline class="demo-table-expand">
                  <el-form-item label="">
                    <el-upload
                      ...
                      >
                      <el-button size="small"  @click.native.prevent="open(props.row.gitUrl)" type="warning" >上传jar包</el-button>
                    </el-upload>
                  </el-form-item>
                </el-form>
              </template>
            ...
            <el-table-column
              ...
              <template slot-scope="scope">
                <el-button :loading="scope.row.load" :type="scope.row.type" size='medium'  @click.native.prevent="open1(scope)">{{scope.row.btnTxt}}</el-button>
